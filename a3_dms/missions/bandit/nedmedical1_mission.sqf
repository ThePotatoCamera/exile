...
if (_difficulty isEqualTo "hardcore") then {
												...
												_vehicle = ["C_Truck_02_covered_F",[(_pos select 0) -30, (_pos select 1) -30],_pinCode] call DMS_fnc_SpawnPersistentVehicle;
												_msgWIN = ['#0080ff',format ["Convicts freed the hospital and got free meds, entry code is %1...",_pinCode]];
											} else
											{
												_vehicle = ["C_Truck_02_covered_F",[(_pos select 0) -30, (_pos select 1) -30,0],[], 0, "CAN_COLLIDE"] call DMS_fnc_SpawnNonPersistentVehicle;
