...
if (_difficulty isEqualTo "hardcore") then
{
	...
	_vehicle = ["O_Truck_03_covered_F",[(_pos select 0) +17.2, (_pos select 1) -0],_pinCode] call DMS_fnc_SpawnPersistentVehicle;
...
{
	_vehicle = ["O_Truck_03_covered_F",[(_pos select 0) +17.2, (_pos select 1) -0,0],[], 0, "CAN_COLLIDE"] call DMS_fnc_SpawnNonPersistentVehicle;
