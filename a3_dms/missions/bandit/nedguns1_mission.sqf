...
if (_difficulty isEqualTo "hardcore") then
{
	...
	_vehicle = ["O_Truck_03_covered_F",_pos getPos [30, random 360],_pinCode] call DMS_fnc_SpawnPersistentVehicle;
	_msgWIN = ['#0080ff',format ["Convicts have got their hands on the weapons, entry code for Tempest is %1...",_pinCode]];
} else
{
	_vehicle = ["O_Truck_03_covered_F",_pos getPos [30, random 360]] call DMS_fnc_SpawnNonPersistentVehicle;
...
// Create Crate type
_crate1 = ["IG_supplyCrate_F",_pos] call DMS_fnc_SpawnCrate;
