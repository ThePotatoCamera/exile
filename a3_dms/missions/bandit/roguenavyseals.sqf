...
// Create Crate
_crate = ["IG_supplyCrate_F",_pos] call DMS_fnc_SpawnCrate;
...
_msgStart = ['#FFFF00',"A squad of professional Navy Seals is performing guerilla warfare in convict land. Deal with them!"];
