...
switch (_difficultyM) do
{
	...
	case "difficult":
	{
		...
		_AIdelay = (55 + (round (random 120)));
		_cash = (1000 + round (random (1000)));					//this gives 750 to 1750 cash			
	...
	default
	{
		...
		_AIwave = (6 + (round (random 2)));
		_AIdelay = (55 + (round (random 120)));
		_cash = (2000 + round (random (2000)));					//this gives 1000 to 2500 cash			
		_crate_weapons0 	= (30 + (round (random 30)));
		_crate_items0 		= (40 + (round (random 40)));
		_crate_backpacks0 	= (2 + (round (random 1)));
		_crate_weapons1 	= (15 + (round (random 10)));
