...
switch (_difficultyM) do
{
	...
	case "difficult":
	{
		...
		_AIdelay = (55 + (round (random 120)));
		_cash0 = (1000 + round (random (1000)));					//this gives 750 to 1750 cash
		_cash1 = (1000 + round (random (1000)));					//this gives 750 to 1750 cash
		_crate_weapons0 	= (30 + (round (random 20)));
		_crate_items0 		= (15 + (round (random 10)));
		_crate_backpacks0 	= (3 + (round (random 1)));
		_crate_weapons1 	= (10 + (round (random 5)));
	...
	default
	{
		...
		_AIwave = (6 + (round (random 2)));
		_AIdelay = (55 + (round (random 120)));
		_cash0 = (2000 + round (random (2000)));					//this gives 1000 to 2500 cash
		_cash1 = (2000 + round (random (2000)));					//this gives 1000 to 2500 cash
		_crate_weapons0 	= (50 + (round (random 15)));
		_crate_items0 		= (30 + (round (random 20)));
		_crate_backpacks0 	= (2 + (round (random 1)));
		_crate_weapons1 	= (20 + (round (random 10)));
		_crate_items1 		= (60 + (round (random 25)));
