...
/* Mission System Settings */
	...
	DMS_MarkerText_MissionPrefix		= "Misión:";				// The text displayed before the mission name in the mission marker.
	...
	DMS_MarkerText_AIName				= "Unidades";					// What the AI will be called in the map marker. For example, the marker text can show: "Car Dealer (3 Units remaining)"
...
/* DonkeyPunchDMS Custom Side Factions */
	...
	DMS_ai_freezingDistance				= 1000;						// If there are no players within this distance of the leader of an AI group, then the AI group will be "frozen".
	DMS_ai_unfreezingDistance			= 1000;						// If there are players within this distance of the leader of an AI group, then the AI group will be "un-frozen".
	...
	DMS_ai_skill_static					= [["aimingAccuracy",0.20],["aimingShake",0.70],["aimingSpeed",0.65],["spotDistance",0.70],["spotTime",0.50],["courage",1.00],["reloadSpeed",1.00],["commanding",1.00],["general",1.00]];	// Static AI Skills
	...
	DMS_ai_skill_hardcore				= [["aimingAccuracy",0.85],["aimingShake",0.90],["aimingSpeed",0.85],["spotDistance",0.90],["spotTime",1.00],["courage",1.00],["reloadSpeed",1.00],["commanding",1.00],["general",1.00]]; 	// Hardcore
	...
	DMS_AI_AimCoef_difficult			= 0.45;						// "Custom Aim Coefficient" (weapon sway multiplier) for "difficult" AI
