...
//        	"CUP_smg_EVO_MRad_Flashlight_Snds",
	...
	{
		name = "CUP Ametralladores ligeras";
		icon = "a3\ui_f\data\gui\Rsc\RscDisplayArsenal\itemacc_ca.paa";
		items[] =
		{
            "CUP_lmg_L7A2",
...
/*        	"CUP_launch_Igla",
	...
	{
		name = "CUP Munición de lanzadores";
		icon = "a3\ui_f\data\gui\Rsc\RscDisplayArsenal\itemacc_ca.paa";
		items[] =
		{
 /*        	"CUP_Igla_M",
