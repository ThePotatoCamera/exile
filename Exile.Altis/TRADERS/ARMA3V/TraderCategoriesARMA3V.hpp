	...
	{
		name = "Arma 3 Helicópteros desarmados";
		icon = "a3\ui_f\data\gui\Rsc\RscDisplayArsenal\itemacc_ca.paa";
		items[] =
		{
			"B_Heli_Light_01_F",
	...
	{
		name = "Arma 3 Helicópteros armados";
		icon = "a3\ui_f\data\gui\Rsc\RscDisplayArsenal\itemacc_ca.paa";
		items[] =
		{
