...
class CfgAdminToolkitCustomMod {
	...
	QuickButtons[] = {
		...
		{"Mensaje de reinicio", "['messageall', '¡Reiniciando el servidor en pocos minutos!'] call AdminToolkit_doAction"},
		/* Quickly get a Helicopter */
		{"Dame un heli", "['getvehicle', 'B_Heli_Light_01_armed_F'] call AdminToolkit_doAction"},
	};
};
...
class CfgFlags 
{
	...
	{
		name = "España2942";
		texture = "custom\flags\clan.paa";
		uids[] = {};
	};
	class Espectre
	{
		name = "Comando Espectre";
		texture = "custom\flags\espectre.paa";
		uids[] = {};
	};
	class Tercios1
	{
		name = "Tercios 1";
		texture = "custom\flags\tercios1.paa";
		uids[] = {};
	};
	class Tercios2
	{
		name = "Tercios 2";
		texture = "custom\flags\tercios2.paa";
		uids[] = {};
	};
	class Argentina
	{
		name = "Argentina";
		texture = "custom\flags\argentina.paa";
		uids[] = {};
	};
	class Brasil
	{
		name = "Brasil";
		texture = "custom\flags\brasil.paa";
		uids[] = {};
	};
	class Canarias
	{
		name = "Canarias";
		texture = "custom\flags\canarias.paa";
		uids[] = {};
	};
	class CostaRica
	{
		name = "Costa Rica";
		texture = "custom\flags\costa_rica.paa";
		uids[] = {};
	};
	class Cuba
	{
		name = "Cuba";
		texture = "custom\flags\cuba.paa";
		uids[] = {};
	};
	class Espana
	{
		name = "España";
		texture = "custom\flags\espana.paa";
		uids[] = {};
	};
	class Honduras
	{
		name = "Honduras";
		texture = "custom\flags\honduras.paa";
		uids[] = {};
	};
	class Madrid
	{
		name = "Madrid";
		texture = "custom\flags\madrid.paa";
		uids[] = {};
	};
	class Mexico
	{
		name = "México";
		texture = "custom\flags\mexico.paa";
		uids[] = {};
	};
	class Peru
	{
		name = "Perú";
		texture = "custom\flags\peru.paa";
		uids[] = {};
	};
	class RepublicaDominicana
	{
		name = "República Dominicado";
		texture = "custom\flags\republica_dominicana.paa";
		uids[] = {};
	};
	class Uruguay
	{
		name = "Uruguay";
		texture = "custom\flags\uruguay.paa";
		uids[] = {};
	};
	class Valencia
	{
		name = "C. Valenciana";
		texture = "custom\flags\valencia.paa";
		uids[] = {};
	};
};
...
class CfgTerritories
{
	...
	prices[] = 
	{
		...
		{5000,					15,			500 				}, // Level 1
		{10000,					30,			500 				}, // Level 2 
		{15000,					45,			500 				}, // Level 3
		{20000,					60,			500					}, // Level 4
		{25000,					75,			500					}, // Level 5
		{30000,					90,			500					}, // Level 6
		{35000,					105,		500					}, // Level 7
		{40000,					120,		500					}, // Level 8
		{45000,					135,		500					}, // Level 9
...
class CfgXM8 
{
	...
	*/
	class ExAd_Info
    {
        title = "Reglas del servidor";				//IDC:50100 -> 50102 || These need to be unique and out of range from each other
        controlID = 50100;                  
