...
///////////////////////// V0.3.5
class EBM_brickwall_gate_Kit								{ quality = 5; price = 10000;sellPrice = 50;  };
class EBM_metalwall_gate_Kit								{ quality = 5; price = 20000;sellPrice = 50;  };
class Land_i_shed_ind_F_Kit									{ quality = 6; price = 100000;sellPrice = 50;  };
class EBM_Helipad2_Kit										{ quality = 4; price = 100000;sellPrice = 50;  };
class Land_d_House_Big_01_V1_F_Kit							{ quality = 4; price = 150000;sellPrice = 50;  };
class Land_u_House_Big_01_V1_F_Kit							{ quality = 4; price = 150000;sellPrice = 50;  };
class Land_i_Shop_01_V2_F_Kit								{ quality = 4; price = 150000;sellPrice = 50;  };
class Land_d_Shop_01_V1_F_Kit								{ quality = 4; price = 100000;sellPrice = 50;  };
class Land_u_Shop_01_V1_F_Kit								{ quality = 4; price = 150000;sellPrice = 50;  };
class Land_i_Addon_02_V1_F_Kit								{ quality = 4; price = 100000;sellPrice = 50;  };
class Land_d_Addon_02_V1_F_Kit								{ quality = 4; price = 100000;sellPrice = 50;  };
class Land_i_House_Small_01_V1_F_Kit						{ quality = 4; price = 100000;sellPrice = 50;  };
class Land_d_House_Small_01_V1_F_Kit						{ quality = 4; price = 100000;sellPrice = 50;  };
