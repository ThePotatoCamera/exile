...
class CfgExileLootServer
{
	...
	class ItemGroups
	{
		...
		*/
		Extras[] = {"Exile_Item_Hammer", "Exile_Item_Carwheel", "Exile_Item_OilCanister", "Exile_Item_Rope", "Exile_Item_CordlessScrewdriver", "Exile_Item_Wrench", "Exile_Item_SleepingMat"};
		Unused[] = {"Exile_Item_FireExtinguisher", "Exile_Item_Defibrillator"};
	};
};
class CfgSettings
{
